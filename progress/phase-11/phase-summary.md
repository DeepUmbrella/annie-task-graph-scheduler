...
| ID | 状态 | 任务 |
|---|---|---|
| T060 | todo | [Team snapshot minimal model](./tasks/task-060-team-snapshot-minimal-model.md) |
| T061 | todo | [Intent planner handoff](./tasks/task-061-intent-planner-handoff.md) |
...
- Phase 01-10 已完成。
- Phase 11 已规划。
- 下一步进入 T060：Team snapshot minimal model。
