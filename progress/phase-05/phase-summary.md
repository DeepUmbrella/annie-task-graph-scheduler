...
| ID | 状态 | 任务 |
|---|---|---|
| T028 | todo | [Cross-project 模型定义](./tasks/task-028-cross-project-model.md) |
| T029 | todo | [Project Registry 与本地持久化](./tasks/task-029-project-registry.md) |
| T030 | todo | [Global Queue Builder](./tasks/task-030-global-queue-builder.md) |
| T031 | todo | [Cross-project Scheduler](./tasks/task-031-cross-project-scheduler.md) |
| T032 | todo | [Global Agent Pool](./tasks/task-032-global-agent-pool.md) |
| T033 | todo | [CLI project / queue 命令](./tasks/task-033-cli-project-queue.md) |
